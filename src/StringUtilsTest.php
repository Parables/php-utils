...
it(
    'can convert to PascalCase', function ($input, $output) {
...
it(
    'can convert to camelCase', function ($input, $output) {
...
it(
    'can convert to snake_case', function ($input, $output) {
...
it(
    'can convert to kebab-case', function ($input, $output) {
